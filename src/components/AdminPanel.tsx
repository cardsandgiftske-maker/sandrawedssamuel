...
export default function AdminPanel() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    if (
      cleanPass === '#sandra&sam2026' ||
      cleanPass === 'sandra&sam2026' ||
      cleanPass === '#sandra&sm2026' ||
      cleanPass === 'sandra&sm2026' ||
      cleanPass === '#sandraandsm2026' ||
      cleanPass === 'sandraandsm2026' ||
      cleanPass === '#sandraandsam2026' ||
      cleanPass === 'sandraandsam2026' ||
                ...
                <div className="p-6 overflow-y-auto space-y-6 flex-1 flex flex-col">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    ...
                    <div className="bg-[#FCFAF7] border border-stone-200 p-4 rounded-2xl flex items-center gap-3.5 shadow-sm">
                      ...
                      <div>
                        <p className="text-[10px] text-stone-500 uppercase font-sans font-bold">Total RSVP Responses</p>
                    ...
                    <div className="bg-[#FCFAF7] border border-stone-200 p-4 rounded-2xl flex items-center gap-3.5 shadow-sm">
                      ...
                      <div>
                        <p className="text-[10px] text-stone-500 uppercase font-sans font-bold">Confirmed Attending</p>
                        <p className="text-xl font-semibold font-serif text-emerald-850">{totalAttending}</p>
                      </div>
                    </div>
                    ...
                    <table className="w-full text-left text-xs border-collapse min-w-[700px]">
                      <thead>
                        <tr className="bg-stone-50 border-b border-stone-200 text-stone-550 font-sans font-bold uppercase tracking-wider">
                          <th className="p-4">Full Name(s)</th>

    ...
    <>
      ...
      <header className="fixed top-0 inset-x-0 z-40 bg-[#FCFAF7]/90 backdrop-blur-md border-b border-pink-100/60 transition-all">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          ...
          >
            <span className="text-[#5A1827]">SANDRA</span>
            <span className="text-[#D4AF37] font-serif text-sm italic font-normal">&amp;</span>
            <span className="text-[#5A1827]">SAM</span>
          </button>
                ...
                <button
                  ...
                  className={`px-3 py-1.5 rounded-full transition-all flex items-center gap-1.5 cursor-pointer hover:text-stone-950 ${
                    activeSection === item.id 
                      ? 'bg-[#5A1827] text-[#FFF9F0] border border-[#D4AF37]/50 font-bold shadow-sm' 
                      : 'border border-transparent hover:bg-pink-50'
                  }`}
                >
                  <IconComp className={`w-3.5 h-3.5 ${activeSection === item.id ? 'text-[#D4AF37]' : ''}`} />
          ...
          <button
            ...
            className="md:hidden px-4 py-1.5 bg-[#5A1827] hover:bg-[#430F1B] border border-[#D4AF37]/50 text-[#FFF9F0] font-sans font-extrabold text-[10px] uppercase tracking-widest rounded-full transition-all cursor-pointer shadow-sm flex items-center gap-1.5"
          >
